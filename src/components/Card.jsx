        ...
        <>
            <div className={classes} style={{"height": containerHeight}}>
                <div className="relative overflow-hidden rounded-lg" style={{"height": height, "width": width}}>
                    {props.children}
                    <figure className="bg-[#777]" style={{"height": height}}>
                        <img src={posterUrl} />
                    </figure>
                    <figcaption className="absolute py-2 rounded-b-lg bottom-0 left-1/2 -translate-x-1/2 text-white text-xs text-center bg-black/70" style={{"width": width}}>
