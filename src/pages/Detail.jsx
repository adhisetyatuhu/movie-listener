            ...
            <div className="my-8">
                <div className="relative" style={{"backgroundImage": "url('https://image.tmdb.org/t/p/original/zZDkgOmFMVYpGAkR9Tkxw0CRnxX.jpg')"}}>
                    <div>
                        ...
                        <figure className="h-[28rem] bg-black/80 flex items-center">
                            <img className="h-96 mt-8 rounded-lg border border-white/50" src="https://image.tmdb.org/t/p/original/6FfCtAuVAW8XJjZ7eWeLibRLWTw.jpg" />
                            <div className="flex items-start">
                                <div className="p-8 text-white">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <p class="ms-2 text-sm font-bold text-white-900">8.2</p>
                                        <span class="w-1 h-1 mx-1.5 bg-white rounded-full"></span>
                                        <a href="#" class="text-sm font-medium text-white-900 underline hover:no-underline">20578 voters</a>
                                    </div>
                                    {/* end rating */}
